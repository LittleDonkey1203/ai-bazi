...
export const FIVE_ELEMENTS = {
  generates: {
    ...
    金: '水',
    水: '木',
  } satisfies Record<FiveElement, FiveElement>,
  destroys: {
    木: '土',
    土: '水',
    水: '火',
...
export const STEMS: Record<Stem, FiveElement> = {
  甲: '木',
  乙: '木',
  丙: '火',
  丁: '火',
...
export const HIDDEN_STEMS: Record<Branch, Partial<Record<FiveElement, number>>> = {
  子: { 水: 1.0 },
  丑: { 土: 0.6, 水: 0.3, 金: 0.1 },
  寅: { 木: 0.6, 火: 0.3, 土: 0.1 },
  卯: { 木: 1.0 },
...
export const ELEMENT_KEYS: FiveElement[] = ['金', '木', '水', '火', '土'];

export const POSITION_WEIGHTS: Record<BaziIndex, number> = {
  0: 5,
  1: 10,
  2: 10,
  3: 40,
...
export const POSITION_LABELS: Record<BaziIndex, string> = {
  0: '年干',
  1: '年支',
  2: '月干',
  3: '月支',
...
export const STEM_SCORE_INDEXES: StemScoreIndex[] = [0, 2, 4, 6];
export const ROOT_CHECK_STEM_INDEXES: Array<0 | 2 | 6> = [0, 2, 6];
export const BRANCH_SCORE_INDEXES: BranchScoreIndex[] = [1, 3, 5, 7];
export const ADJACENT_STEM_PAIRS: AdjacentStemPair[] = [
  [0, 2],
  [2, 4],
  [4, 6],
];

export const STEM_COMBINATION_RULES: StemCombinationRule[] = [
...
export const THREE_MEETING_RULES: BranchMutationRule[] = [
...
export const THREE_HARMONY_RULES: BranchMutationRule[] = [
...
export const HALF_HARMONY_RULES: BranchMutationRule[] = [
...
export const SIX_COMBINATION_RULES: BranchMutationRule[] = [
...
export const SAME_CLASH_RULES: BranchMutationRule[] = [
...
export const OPPOSING_CLASH_RULES: BranchMutationRule[] = [
...
export const THREE_PUNISHMENT_RULES: BranchMutationRule[] = [
...
export const SIX_HARM_RULES: BranchMutationRule[] = [
...
export function getBranchDominantElement(branch: Branch): FiveElement {
  const hidden = HIDDEN_STEMS[branch];
  return ELEMENT_KEYS.reduce<FiveElement>((currentBest, candidate) => {
...
export function getGeneratorElement(targetElement: FiveElement): FiveElement {
  return ELEMENT_KEYS.find((element) => FIVE_ELEMENTS.generates[element] === targetElement) || '土';
}

export function getDestroyedElement(element: FiveElement): FiveElement {
  return FIVE_ELEMENTS.destroys[element];
}

export function getDestroyerElement(targetElement: FiveElement): FiveElement {
