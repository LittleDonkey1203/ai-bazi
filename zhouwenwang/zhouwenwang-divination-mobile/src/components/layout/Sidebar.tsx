...
const Sidebar: React.FC<SidebarProps> = ({ className }) => {
  ...
  return (
    <>
      <motion.div
        className={`
          bg-night border-r border-[#333333] fixed left-0 top-0 h-screen flex flex-col transition-all duration-300 ease-in-out z-40
          ${className || ''}
        `}
        style={{
      ...
      >
        ...
        <div className={`p-4 border-b border-[#333333] flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'}`}>
          <AnimatePresence>
            {!isCollapsed && (
              ...
              >
                <Star className="w-5 h-5 text-brand" style={{ marginRight: '1rem' }} />
        ...
        <div className="mt-auto">
          <motion.div
            className="p-4 border-t border-[#333333] bg-night"
