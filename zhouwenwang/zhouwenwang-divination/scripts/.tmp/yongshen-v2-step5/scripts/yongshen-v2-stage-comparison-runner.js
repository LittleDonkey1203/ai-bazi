import { HeavenlyStemCombiner, PatternClassifier, YongShenEngineV2Step1, YongShenEngineV2Step2, YongShenEngineV2Step3, YongShenEngineV2Step4, YongShenEngineV2Step5, YongShenMapper, } from '../src/games/bazi/yongshen-v2/index.js';
const TEST_CASES = [
...
function buildSnapshot(stage, totalScore, scores, patternClassification, mapping) {
    return {
        stage,
...
function main() {
    ...
    TEST_CASES.forEach((testCase) => {
        ...
        const step1Pattern = patternClassifier.classifyPattern(step1.baseScore, stemCombiner.applyStemCombinations(step1.baseScore, step1.finalScores), step1.finalScores, step1.totalScore);
        ...
        const step2Pattern = patternClassifier.classifyPattern(step2.baseScore, step2.stemCombinations, step2.finalScores, step2.totalScore);
        ...
        const step3Pattern = patternClassifier.classifyPattern(step3.baseScore, step3.stemCombinations, step3.finalScores, step3.totalScore);
